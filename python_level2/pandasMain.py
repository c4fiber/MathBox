...
# 나라별 사망률 구하기
df_countries_cases['Death Rate (Per 100)'] = 100 * \
    df_countries_cases['Deaths'] / df_countries_cases['Confirmed']
print(df_countries_cases)


# 사망률 가장 높은 10개 나라 (사망자 1000명 이상)
df_top10_countries_dr = df_countries_cases[df_countries_cases['Deaths'] >= 1000].sort_values(
    'Death Rate (Per 100)')[-10:]
print(df_top10_countries_dr)


# 사망률 바 그래프
plt.barh(df_top10_countries_dr.index,
         df_top10_countries_dr['Death Rate (Per 100)'], color="darkcyan")
